...
DEFINE_LOG_CATEGORY(LogVCharacter);
...
void AVCharacter::NotifyControllerChanged()
{
...
void AVCharacter::Move(const FInputActionValue& Value)
{
...
void AVCharacter::AttackPressed()
{
	// Implement attack logic here
	UE_LOG(LogVCharacter, Log, TEXT("Attack Pressed"));
	// Example: Play attack animation or trigger attack event
	// PlayAnimMontage(AttackMontage);
	// TriggerAttackEvent();
}

void AVCharacter::AttackReleased()
{
	// Implement attack release logic here
	UE_LOG(LogVCharacter, Log, TEXT("Attack Released"));
	// Example: Stop attack animation or trigger attack end event
	// StopAnimMontage();
	// TriggerAttackEndEvent();
}
